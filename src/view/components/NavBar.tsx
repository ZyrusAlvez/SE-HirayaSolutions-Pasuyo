...
export default function NavBar() {
  ...
  return (
    <View style={{ backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#F3F4F6' }}>
      ...
      <TouchableOpacity testID="nav-chat" style={{ flex: 1, alignItems: 'center' }} activeOpacity={0.7} onPress={() => handleNavigation('/chat')}>
        <View>
      ...
      <TouchableOpacity testID="nav-dashboard" style={{ flex: 1, alignItems: 'center' }} activeOpacity={0.7} onPress={() => handleNavigation('/dashboard')}>
