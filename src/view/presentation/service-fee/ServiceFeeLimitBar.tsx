...
export default function ServiceFeeLimitBar({ totalFees, isVerified, onPay }: Props) {
  ...
  return (
    <View style={{ marginBottom: 16, gap: 12 }}>
      ...
      {/* Pay button — separate from card */}
      {totalFees > 0 && (
        <TouchableOpacity
          activeOpacity={0.7}
          onPress={onPay}
          style={{ backgroundColor: '#34D399', borderRadius: 12, paddingVertical: 14, alignItems: 'center' }}
        >
