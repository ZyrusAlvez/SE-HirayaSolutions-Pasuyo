...
<body>
  ...
  "verification-approved": `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p>Congratulations! Your identity has been verified. You now have full access to all features on Pasuyo.</p>
      <div class="status-card">
        <div class="icon">&#10003;</div>
        <div class="label">Identity Verified</div>
      </div>
      <div class="cta-wrap">
        <a href="https://pasuyo.xyz" class="cta-button">Open Pasuyo</a>
      </div>
  ...
  "verification-rejected": `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <h2>Your Verification Has Been Rejected</h2>
      <p>Unfortunately, your verification request could not be approved. Please review your submitted documents and try again with valid information.</p>
      <div class="status-card">
        <div class="icon">&#10007;</div>
...
<head>
  ...
  <style>
    ...
    .body h2 { color: #111827; font-size: 20px; font-weight: 700; margin: 0 0 8px; }
    .body p { color: #6B7280; font-size: 14px; line-height: 1.7; margin: 0 0 24px; }
    .reason-card { background-color: #FEF2F2; border: 1px solid #FECACA; border-radius: 12px; padding: 16px; margin-bottom: 24px; }
    .reason-card .reason-label { font-size: 12px; font-weight: 600; color: #991B1B; margin: 0 0 4px; }
    .reason-card .reason-value { font-size: 14px; font-weight: 700; color: #DC2626; margin: 0; }
    .footer { padding: 20px 40px; text-align: center; border-top: 1px solid #F3F4F6; }
    .footer p { color: #9CA3AF; font-size: 11px; margin: 0; line-height: 1.6; }
  </style>
</head>
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p>Your Pasuyo account has been suspended due to a violation of our platform rules. You will not be able to access the platform until your account is restored.</p>
      <div class="reason-card">
        <p class="reason-label">Reason</p>
        <p class="reason-value">{{suspend_reason}}</p>
      </div>
      <p>If you believe this was a mistake, please contact support for assistance.</p>
    </div>
    <div class="footer">
