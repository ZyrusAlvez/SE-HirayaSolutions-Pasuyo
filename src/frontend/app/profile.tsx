...
import { View, Text, TouchableOpacity, TextInput, Image, ScrollView, ActivityIndicator, Platform } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (pendingImageUri) {
        finalAvatarUrl = await uploadAvatar(user.id, pendingImageUri);
